  ...
  return (
    <>
      ...
      <View
        ...
        <Button
          variant="plain"
          className="bg-secondary/20 dark:bg-card h-14 flex-row items-center gap-0 rounded-full px-2.5"
          ...
          <View className="flex-1 px-2">
            <Text numberOfLines={1} variant="callout" className="text-muted-foreground font-normal">
